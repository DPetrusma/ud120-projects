...
estimators = [("Scale", MinMaxScaler()), ("Reduce_Dimension", PCA(svd_solver = "randomized", n_components = 15)), ("Classifier", RandomForestClassifier(min_samples_split = 11, criterion = "gini", min_samples_leaf = 1))]
